...
public class OrdersListsEntity {
    ...
    public OrdersListsEntity(Long id, String number, CustomersEntity customers, PaymentsTypeEntity paymentsType, DeliveriesMethodEntity deliveriesMethod, String address_delivery, List<GoodsOrdersEntity> goodsOrders) {
        this.id = id;
        this.number = number;
